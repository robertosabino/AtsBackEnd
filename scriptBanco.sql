...
/****** Object:  Database [ats]    Script Date: 27/09/2022 11:08:49 ******/
CREATE DATABASE [ats]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'ats', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\ats.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'ats_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\ats_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [ats] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [ats] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [ats] SET QUERY_STORE = OFF
GO
